...
<body>
	...
	<div id="content">
		...
		<s:form action="login" theme="simple" method="post" id="login-form">
			...
			<fieldset>
				...
				<p>
					<s:textfield label="Username" name="user.username" cssClass="round full-width-input" onfocus="true"/>
				</p>
	...
	<div id="footer">
		...
		<p><strong>SimpleAdmin</strong> theme by <a href="https://www.facebook.com/krishna.nagidi1">Krishna Nagidi</a></p>
